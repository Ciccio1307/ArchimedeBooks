...
<body>
 <script type ="text/javascript">
        ...
        ?>
        <h1><center><font
        face="impact">Archimede Books <br>ACCOUNT SuperUser-Interrogazione Guadagno Studente
    ...
    <center><h3>Inserisci un periodo specifico per conoscere il guadagno di ogni singolo venditore in quel momeno</h3></center>
    <fieldset>
      <center>
    <form action="guadagnoVenditori.php" method="post">
